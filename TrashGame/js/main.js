var game = new Phaser.Game(1536, 2048, Phaser.AUTO, 'flappyBird'); // Objet jeu de type Phaser
game.transparent = true;

var gameState = {};


gameState.load = function() { };                                                          // variable "load"
...
/***************************** GAME SCALE *****************************/  
		...
		this.game.stage.scaleMode = Phaser.StageScaleMode.SHOW_ALL;                       // Le jeu se redimensionne en fonction de l'écran
...
/***************************** SPRITES *****************************/
        ...
        // création objet par la création du sprite (nom objet / lien image / lien json) //
        
        
		this.game.load.atlasJSONHash('bird', 'img/bird.png', 'data/bird.json');           // bird - png et json

		this.game.load.image('background', 'img/background.png');                         // background

		this.game.load.image('ready', 'img/ready.png');                                   // Image "Get Ready"

		this.game.load.image('gameOver', 'img/game-over.png');                            // Image "Game Over"

		this.game.load.image('buttonPlay', 'img/button-play.png');                        // Bouton play
...
/***************************** AUDIO *****************************/
		...
		this.game.load.audio('hit', ['sons/hit.wav', 'sons/hit.ogg']);                    // Quand l'oiseau touche le sol ou un tuyau

		this.game.load.audio('fall', ['sons/fall.wav', 'sons/fall.ogg']);                 // Quand l'oiseau tombe après touché un tuyau

		this.game.load.audio('flap', ['sons/flap.wav', 'sons/flap.ogg']);                 // Quand l'oiseau vole

		this.game.load.audio('point', ['sons/point.wav', 'sons/point.ogg']);              // Quand l'oiseau dépasse un tuyau

		this.game.load.audio('menu', ['sons/menu.wav', 'sons/menu.ogg']);                 // Quand on clique sur le bouton play
	},
